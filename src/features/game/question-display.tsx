...
function DialedQuestionView({
  ...
  // Memorize phase: show color for the first N seconds
  ...
  return (
    <>
          ...
          {isMemorizing ? (
            ...
            >
              ...
              <p className="text-sm text-surface-400 mt-1">
                {memDuration - elapsed}s restantes
              </p>
            </motion.div>
          ) : (
            <motion.div
      ...
      <div className="flex justify-center gap-4 mb-6">
        {/* Target color (shown during memorize phase, hidden after) */}
        <motion.div
