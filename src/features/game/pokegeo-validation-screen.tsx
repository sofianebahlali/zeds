...
export function PokeGeoValidationScreen() {
  const validationData = useGameStore((s) => s.pokeGeoValidationData);
  const answerResults = useGameStore((s) => s.pokeGeoAnswerResults);
  const isHost = usePlayerStore((s) => s.isHost);
  const { validatePokeGeoAnswer } = useSocket();
      ...
      >
        ...
        <div className="text-center mb-4 pt-2">
          ...
          <div className="flex justify-center mb-1">
            <div className="px-4 py-1.5 rounded-xl bg-gradient-to-br from-red-500 to-yellow-500">
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3 mt-auto">
                  <Button
                    ...
                    size="lg"
                    fullWidth
                    onClick={() => validatePokeGeoAnswer(currentPlayer.playerId, false)}
                  ...
                  <Button
                    ...
                    size="lg"
                    fullWidth
                    onClick={() => validatePokeGeoAnswer(currentPlayer.playerId, true)}
