...
export function ConsensusValidationScreen() {
  ...
  const { validateConsensusAnswer } = useSocket();
      ...
      >
        ...
        <div className="text-center mb-4 pt-2">
          ...
          <div className="flex justify-center mb-1">
            <div className="px-4 py-1.5 rounded-xl bg-gradient-to-br from-brand-500 to-brand-700">
              <span className="text-base font-display font-bold text-white">
                {validationData.prompt}
              </span>
            </div>
          </div>
          <p className="text-surface-500 text-xs">{validationData.category}</p>
        </div>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3 mt-auto">
                  <Button
                    ...
                    size="lg"
                    fullWidth
                    onClick={() => validateConsensusAnswer(currentPlayer.playerId, false)}
                  ...
                  <Button
                    ...
                    size="lg"
                    fullWidth
                    onClick={() => validateConsensusAnswer(currentPlayer.playerId, true)}
